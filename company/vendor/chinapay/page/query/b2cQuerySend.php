...
$query_url = $settings->get("query_url");
?>
...
<body>
	<form name="query" action="<?php echo $query_url ?>" method="POST"
		target="_blank">
		...
		<hr>
<?php
$params = "BusiType;MerId;MerOrderNo;Signature;TranDate;TranType;TranReserved;Version;TranTime";
...
?>
	如果您的浏览器没有弹出支付页面，请点击按钮<input type='button' value='提交查询'
			onClick='document.query.submit()'>再次提交。
	</form>
