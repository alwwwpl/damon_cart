...
<form name="createOrder" action="/chinapay_demo/sign.php" method="POST">
	<table>
		...
		<tr>
			...
			<td>
                    <input type="text" name="OrderAmt" value="1" maxlength="12"> &nbsp;(1-12位数字，不填默认金额为1分)
            </td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
                    <input type="text" name="MerPageUrl" value="http://<?php echo  $_SERVER['HTTP_HOST'];?>/chinapay_demo/pgReturn.php" maxlength="80"> &nbsp;(不超过80字节，商户系统前台应答接受地址)
            </td>
		</tr>
					<tr>
			<td>
			...
			<td>
                    <input type="text" name="MerBgUrl" value="http://<?php echo  $_SERVER['HTTP_HOST'];?>/chinapay_demo/bgReturn.php" maxlength="80"> &nbsp;(不超过80字节，商户系统后台应答接受地址)
               </td>
		</tr>
