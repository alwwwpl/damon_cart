                ...
                ?>
                            <li style="padding-top:20px;">
                                <div class="order-box clearfix">
                                    <div style="width: 100%; height: 90px; background: #FFF; font-size: 30px; line-height: 90px; border-bottom: 1px solid #ccc;">至宝母婴</div>
                <?php
                ...
                ?>
                                    <ul class="book-list clearfix">
                                        <a href="/product?product_id=<?= $product['product_id']; ?>&supplier_id=<?= $product['supplier_id'] ?><?= !empty($product['distribute_id']) ? '&distribute_id='.$product['distribute_id'] : '' ?><?= !empty($product['bidding_id']) ? '&bidding_id='.$product['bidding_id'] : '' ?>">
                                            <div class="order-msg">
                                                <img class="img_ware" src="http://cadmin.iddmall.com/image/<?= $product['image']; ?>">
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#order-submit').on('click',function(){
            ...
            {
                layer.msg('请先填写收货地址!');
                location.href = 'http://company.iddmall.com/account/address';
            }
...
?>
<script type="text/javascript">
    location.href = "http://company.iddmall.com/cart/index";
</script>
<?php
}
?>