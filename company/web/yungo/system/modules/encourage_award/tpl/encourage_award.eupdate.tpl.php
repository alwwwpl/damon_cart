...
<form name="myform" action=""  method="post" enctype="multipart/form-data" onSubmit="return InputCheck(this)">
	...
	<tr >
		...
		<td>
		<input type="radio" name="encourage_awardgz" id="encourage_award1" value="1" class="input-text">云购码与一等奖（欢乐码）的距离由近到远依次设置鼓励奖
	...
	<td>&nbsp;<input  class="input-text wid100"  type="text" name="shop_je"  size="20" id="shop_je"/>元（及其以上）</td>	
  	...
  	<tr>
		...
		<td>
			...
			<div><br> 
				2等奖奖励方式:
				<input type="radio" name="option1[]" value="福分:" class="input-text">福分&nbsp;&nbsp;
