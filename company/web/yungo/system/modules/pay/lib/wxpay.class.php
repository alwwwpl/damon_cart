...
class wxpay {
	...
	include_once dirname(__FILE__)."/wxpay/WxPayPubHelper.php";//引入文件需求
		...
		WxPayConf_pub::$APPID=$pay_type_key['APPID']['val'];//微信的APPID
		WxPayConf_pub::$MCHID=$pay_type_key['MCHID']['val'];//微信商户号
		WxPayConf_pub::$KEY=$pay_type_key['KEY']['val'];//微信支付秘钥
	...
	private function config_jsdz(){
		...
		$unifiedOrder = new UnifiedOrder_pub();
			...
			//sign已填,商户无需重复填写
			$unifiedOrder->setParameter("body","闪购商品");//商品描述
			//自定义订单号，此处仅作举例
