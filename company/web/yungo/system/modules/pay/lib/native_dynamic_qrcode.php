...
<body>
    ...
    <div class="wx_header">
        <div class="wx_logo"><img title="一元闪购微信支付" alt="微信支付标志" src="<?php echo G_TEMPLATES_STYLE?>/images/wxlogo_pay.png" /></div>
    </div>
    <div class="weixin">
        <div class="weixin2">
            ...
            <div class="wx_box pngFix">
                ...
                <div class="wx_pay">
                    ...
                    <p><span class="wx_left">商品名称</span><span class="wx_right">闪购商品</span></p>
                </div>
                <div class="wx_kf">
