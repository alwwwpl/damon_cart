...
<div id="header">
    ...
    <a target="_blank" href="<?php echo G_WEB_PATH; ?>" title="网站首页" target="_blank">网站首页</a>
    ...
    <div class="nav" id="nav">    
    	<ul>	
			...
			<li class="normal"><a href="#" onClick="secBoard('nav',3,'or','订单管理');">订单管理</a></li>
            ...
            <li class="normal"><a href="#" onClick="secBoard('nav',6,'yunapp','超级云应用');">超级云应用</a></li>
			 <li class="normal"><a href="#" onClick="secBoard('nav',7,'seo','营销辅助');">站长运营</a></li>
        </ul>
    </div>
</div><!--header end-->
<div id="left">
    <ul class="left_date" id="setting">   
        ...
        <li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/email">邮件发信配置</a></li>
		<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/mobile">短信发信配置</a></li>
		<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/sendconfig">中奖通知设置</a></li>
		<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/template/temp">发送通知模板</a></li>
        <li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/pay/pay/pay_list">支付方式配置</a></li>        
...
<!--li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/plugin/admin/egglotter/listlotter">游戏设置</a></li-->
 <li class="head">增强运营插件</li>
 <?php if(file_exists(G_SYSTEM.'modules/goodspecify/lib/'.'itocode.class.php')){	?><li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/goodspecify/goodspecify/init">手动插队购买</a></li>
<li><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/auto_register/show">会员批量注册</a></li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/autojujgaaa/auto_p/show">自动人气(小额1)</a></li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/autoyyjgapp/auto_p/show">自动购买(中额)测试版</a></li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/auto/auto_p/show">自动购买(大额10)测试版</a></li>

 <li class="head">充值卡管理</li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge">卡密充值</a></li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge/lists">卡密充值管理</a></li>
<li><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/cardrecharge/cardrecharge/update_pwd">卡密密码修改</a></li>
		<?php } ?>
    </ul>
	 <div style="padding:30px 10px; color:#ccc">
     	<p>
        	(c) 2015 DianFengYunGouCMS<br>
			All Rights Reserved.
			系统技术服务:400-8217-023
        </p>
     </div>
...
<div id="right">
	<div class="right_top">
		...
		<!--a href="http://www.81668.net/" target="_blank" class="system_button"><span>提交工单</span></a-->		
