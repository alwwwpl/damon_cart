...
<!DOCTYPE html><!--最后修改paddy 2015-09-12 QQ320023815-->
...
<div class="header-data lr10">
    ...
    <b>开奖状态:</b><b style="color:red;padding-left:10px;">
		<?php if ( ($ginfo['q_uid'] || $ginfo['q_uid_a']) && ($ginfo['shenyurenshu']==0) ) {
					...
					echo "商品还在进行中...";
					echo "<a href='".G_MODULE_PATH."/content/goods_one_ok/".$ginfo['id']."' class='a_button'>（应急揭晓）</a>";
			   }else if($ginfo['shenyurenshu']==0 && $ginfo['xsjx_time'] != 0){
					echo "限时揭晓商品味道揭晓时间...";
			   }else if($ginfo['shenyurenshu']==0 && $ginfo['xsjx_time'] == 0){
	...
	$goucode_calc = $ginfo['q_user_code'];
	  ...
	  if ( $ginfo['shenyurenshu'] > 0 ) {
	    echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	    echo "<a href='javascript:FormClearAssign_Submit()' style='color:blue'>取消指定</a>";
 ...
 <table width="100%" cellspacing="0">
        ...
        <tbody style="text-align:center">
        	...
        	<tr>
                ...
                <td><?php echo $go['uid']; ?><font color="#0c0"> <a style="line-height:30px;color:#f60" title="查看该会员的购买、晒单、中奖记录" target="_blank" href="/?/uname/<?php echo $go['uid']; ?>">活动记录</a></font></td>
		...
		<td><?php 
		  ...
		  if ( $ginfo['q_uid'] && $ginfo['shenyurenshu']==0 ) {
		    ...
		    echo "<input type='submit' value='指定中奖' />\n";
		    echo "</form>";
		  }
		?></td>
