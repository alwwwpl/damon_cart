...
<div class="bk15"></div>
	<ul>
        ...
        <li><a target="_blank" href="<?php echo G_WEB_PATH; ?>"><img src="<?php echo G_GLOBAL_STYLE; ?>/global/image/btn_60_60_i.png"><span>网站首页</span></a></li>
    </ul>
</div>
...
<!------------>
    ...
    <div class="div-about width30">
        ...
        <div class="bk10"></div>
        <ul>
        	<li><i>程序版本:</i>V6.18<font color="#f60">【企业运营版】</font></li>
			<li><i>更新时间:</i>2015/11/18</li>
            <li><i>程序开发:</i>云购系统</li>
            <li><i>版权所有:</i>众筹科技网络有限公司</li>    
        </ul>
            <p style="color:#666; padding:20px;font: 12px/1.5 tahoma,arial,宋体b8b\4f53,sans-serif;">
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;云购管理系统是一款专为云购系统设计的CMS系统,
                具有圈子,限时揭晓,晒单等云购功能。同时应客户需求增加了特定的运营增强插件，让整个运营更加高效，轻松。
            </p> 
    </div>
<!------------>
</div>
