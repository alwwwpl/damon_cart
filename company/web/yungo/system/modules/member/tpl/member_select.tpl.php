...
<form name="myform" action="#" method="post">
  <table width="100%" cellspacing="0">
  	 <tr>
			<td width="220" align="right">要搜索的条件：
				<select name="sousuo">
		...
		?>			
			<tr>
				...
				<td width="100px" align="center">活动记录</td>
		...
		?>
			<tr>
				...
				<td align="center"><a class="style1" title="查看该会员活动记录" target="_blank" href="/?/userbuy/<?php echo $v['uid']; ?>">
活动轨迹</a></td>
