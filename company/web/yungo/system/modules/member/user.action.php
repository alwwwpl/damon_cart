	...
	*/
	...
	public function sendmobile(){
			...
			if(1 == 1){
				...
				_message("正在发送...",WEB_PATH."/member/user/mobilechecker/".$this->segment(4));				
			}else{
				_message("重发时间间隔不能小于2分钟!",WEB_PATH."/member/user/mobilechecker/".$this->segment(4));
			}
...
//
	public function mobilechecker(){
		...
		if($member['mobilecode'] == '-1'){
			...
			header("location:",WEB_PATH."/member/user/mobilechecker/".$this->segment(4));
			exit;
		}
		...
		include templates("user","mobilechecker");
