...
<meta property="qc:admins" content="155414673661151626375" /> 
<body>
<div class="header_top lh40">
<div class="wp">
<div class="lf mr40">
<a href="<?php echo G_WEB_PATH; ?>/"><?php echo _cfg("web_name"); ?>-- 淘时尚，淘精彩，体验不一样全新的购物方式。</a>
</div>
<div class="lf" id="logininfo">
	...
	<p><a href="<?php echo WEB_PATH; ?>/member/home" class="ml10 mr10"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo get_user_img('3030'); ?>" width="30" height="30"/>					
		<?php echo get_user_name(get_user_arr(),'username'); ?></a>&nbsp;&nbsp;欢迎您！<a href="<?php echo WEB_PATH; ?>/member/user/cook_end" class="ml10">退出帐号</a></p>
			<?php  else: ?>
			<p>您好，欢迎光临！<a href="<?php echo WEB_PATH; ?>/login" class="ml10 mr10">登录</a><a href="<?php echo WEB_PATH; ?>/register">注册</a></p>
			<?php endif; ?>
...
<div class="wp">
<div class="lf logo"><a href="<?php echo G_WEB_PATH; ?>/" title="<?php echo _cfg('web_name'); ?>"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo Getlogo(); ?>" height="40" /></a></div>
