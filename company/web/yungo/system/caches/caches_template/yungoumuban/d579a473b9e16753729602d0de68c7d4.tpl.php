...
<style type="text/css">
	*{margin:0;padding:0;}
	...
	body{color:#333;font:12px/1.5 Tahoma,Arial,"微软雅黑",Helvetica,sans-serif;height:auto;width:100%; background-color:#f9f9f9}
	div{margin:0 auto;}
	...
	.box-text{font:12px/1.5 "微软雅黑",Arial,"微软雅黑",Helvetica,sans-serif; font-size:18px;color:#73787b;width:438px;		
