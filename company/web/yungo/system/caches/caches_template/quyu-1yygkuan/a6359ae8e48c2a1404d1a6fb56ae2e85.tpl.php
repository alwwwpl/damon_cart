...
<div class="n-h-tit"><h1 class="header-logo">夺宝结果</h1></div>
</div>
</header>
		...
		<div class="u-Btn"><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/home/userbuylist" class="z-CloseBtn">查看夺宝记录</a></div><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/mobile" class="z-DefineBtn">继续购物</a></div></div>
		</section>
    </div>
