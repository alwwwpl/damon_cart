...
<script type="text/javascript">
    ...
    <section class="clearfix g-Cart">
                 ...
                 ?>
					<li>
						...
						<div class="u-Cart-r">
							...
							<p class="gray9">总共闪购：<em class="arial"><?php echo $Mcartlist[$val['id']]['num']; ?></em>人次/<em class="orange arial">￥<?php echo $Mcartlist[$val['id']]['money']*$Mcartlist[$val['id']]['num']; ?>.00</em></p>
	    ...
	    <div id="divBtmMoney" class="g-Total-bt"><p>总共夺宝
