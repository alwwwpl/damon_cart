...
<meta property="qc:admins" content="364004704700163757" />
...
.m-other a em{
	...
	width:26px;
	height:30px;
	background-image:url(../images/map-icon.gif?v=150129);
	margin-right:2px;
}
</style>
          ...
          <a class="rslides_nav rslides1_nav pre" href="javascript:;" style="display: none;">Previous</a> <a class="rslides_nav rslides1_nav next" href="javascript:;" style="display: none;">Next</a>
			...
			<?php if(defined('G_IN_ADMIN')) {echo '<div style="padding:8px;background-color:#F93; color:#fff;border:1px solid #f60;text-align:center"><b>This Tag</b></div>';}?>
               ...
               <div class="home-event fr">
                    <div class="what-1yyg">
                        <a id="what_1yyg" href="<?php echo G_WEB_PATH; ?>/?/single/newbie" title="什么是欢乐云购？30秒了解" >
...
<div class="g-wrap w1190">
       <!--最新揭晓-->
            <div class="g-title">
                ...
                <div class="m-other fr"><cite><a href="<?php echo WEB_PATH; ?>/goods_lottery" target="_blank" title="看看附近都有谁获得了商品？"><em></em>看看附近都有谁获得了商品？</a></cite></div>
            </div>
            <div class="g-list">
                <ul id="ulNewAwary">
