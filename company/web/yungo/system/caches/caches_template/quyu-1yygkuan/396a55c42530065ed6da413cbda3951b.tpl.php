...
<div class="n-h-tit"><h1 class="header-logo">我的<?php echo _cfg('web_name_two'); ?></h1></div>
</div>
</header>
    ...
    <section class="clearfix g-member">
	    <div class="clearfix m-round m-name">
			<div class="fl f-Himg">
				...
				<img src="<?php if(strpos($member['img'],'http:') === false ): ?><?php echo G_UPLOAD_PATH; ?>/<?php endif; ?><?php echo get_user_key($member['uid'],'img'); ?>" border=0/></a>
	    ...
	    <div class="m-round m-member-nav">
		    <ul id="ulFun">
				<li><a href="<?php echo WEB_PATH; ?>/mobile/home/wrenwu"><b class="z-arrow"></b>任务中心</a></li>
				<!--<li><a href="<?php echo WEB_PATH; ?>/mobile/lottery"><b class="z-arrow"></b>充值转盘</a></li>-->
				...
				<li><a href="<?php echo WEB_PATH; ?>/mobile/home/address"><b class="z-arrow"></b>我的收货地址</a></li>
				...
				<li><a href="<?php echo WEB_PATH; ?>/mobile/home/password"><b class="z-arrow"></b>修改密码</a></li>
				<li><a href="<?php echo WEB_PATH; ?>/mobile/user/cook_end" id="btnLogin" class="nextBtn orgBtn">退出登录</a>
			</ul>
	    </div>
    </section>
