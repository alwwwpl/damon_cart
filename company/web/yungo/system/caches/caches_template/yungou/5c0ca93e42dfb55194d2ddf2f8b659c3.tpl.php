...
<a href="<?php echo WEB_PATH; ?>/member/home">我的<?php echo _cfg('web_name_two'); ?></a>
                 ...
                 <div class="u-select u-select-my">
                     ...
                     <span><a href="<?php echo WEB_PATH; ?>/member/home/modify" title="个人设置">个人设置</a></span>                     <span><a href="<?php echo WEB_PATH; ?>/group" title="<?php echo _cfg('web_name_two'); ?>圈子"><?php echo _cfg('web_name_two'); ?>圈子</a></span>
                 </div>
             </li>
             <li class="f-gap"><s></s></li>
             ...
             <li>
                 <div class="u-menu-hd">
                     <a href="<?php echo WEB_PATH; ?>/single/newbie" title="帮助">帮助</a>
                 </div>
             </li>
             <li class="f-gap"><s></s></li>
             <li>
