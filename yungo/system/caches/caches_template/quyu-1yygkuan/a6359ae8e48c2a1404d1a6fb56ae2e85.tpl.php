...
<head>
    ...
    <title>闪购结果 - <?php echo $webname; ?>触屏版</title>
...
<div class="n-h-tit"><h1 class="header-logo">闪购结果</h1></div>
</div>
</header>
		...
		<div class="u-Btn"><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/home/userbuylist" class="z-CloseBtn">查看闪购记录</a></div><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/mobile" class="z-DefineBtn">继续购物</a></div></div>
		</section>
    </div>
