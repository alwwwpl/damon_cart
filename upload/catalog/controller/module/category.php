	...
	public function index() {
		...
		foreach ($categories as $category) {
			...
			if ($category['category_id'] == $data['category_id']) {
				...
				foreach($children as $child) {
					...
					$children_data[] = array(
						...
						'name' => $child['name'] . ($this->config->get('config_product_count') ? ' (' . $this->model_catalog_product->getTotalProducts($filter_data,$city) . ')' : ''),
			...
			$data['categories'][] = array(
				...
				'name'        => $category['name'] . ($this->config->get('config_product_count') ? ' (' . $this->model_catalog_product->getTotalProducts($filter_data,$city) . ')' : ''),
