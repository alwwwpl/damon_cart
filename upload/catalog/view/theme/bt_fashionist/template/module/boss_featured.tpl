...
<div class="boss-custom-pro <?php echo $class_css; ?>">	
		...
		<div class="product-thumb">
			...
			<div class="image">
				...
				<div class="button-group">
					<a class="btn-action btn-wishlist" onclick="btadd.wishlist('<?php echo $mainproduct['product_id']; ?>');"><i class="fa fa-heart"></i></a>
					<a class="btn-action btn-comapre" onclick="btadd.compare('<?php echo $mainproduct['product_id']; ?>');"><i class="fa fa-arrow-down"></i></a>
				</div>
			</div>
			<?php } ?>			
			...
			<?php //} ?>
			<div class="cart"><button type="button" onclick="btadd.cart('<?php echo $mainproduct['product_id']; ?>');" class="btn-cart" /><i class="fa fa-shopping-cart"></i><?php echo $button_cart; ?></button></div>
			</div>
		</section>
		</div>
	<?php } ?>
	...
	<div class="bt-items bt-product-grid">
		<div id="boss_featured_<?php echo $module; ?>">
			...
			<div class="product-thumb">
				...
				<div class="image">
					...
					<div class="button-group">
						<a class="btn-action btn-wishlist" onclick="btadd.wishlist('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></a>					
						<a class="btn-action btn-comapre" onclick="btadd.compare('<?php echo $product['product_id']; ?>');"><i class="fa fa-arrow-down"></i></a>
					</div>
				</div>
				<?php } ?>
				...
				<div class="caption">
					...
					<div class="cart"><button type="button" onclick="btadd.cart('<?php echo $product['product_id']; ?>');" class="btn-cart" /><i class="fa fa-shopping-cart"></i><?php echo $button_cart; ?></button></div>
				</div>
			</section>			
		...
		<?php if($show_slider){ ?>
			<a id="bt_next_<?php echo $module; ?>" class="btn-nav-center prev nav_thumb" href="javascript:void(0)" title="prev"><i class="fa fa-angle-left" title="Previous"></i></a>
			<a id="bt_prev_<?php echo $module; ?>" class="btn-nav-center next nav_thumb" href="javascript:void(0)" title="next"><i class="fa fa-angle-right" title="Next"></i></a>
			<?php if($nav_type){ ?>
