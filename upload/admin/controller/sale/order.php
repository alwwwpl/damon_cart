...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
                ...
                'discount'      => $this->model_sale_order->getOrderTotalDiscount($result['order_id']),
    ...
    public function discount()
    {
        ...
        if (isset($this->request->post['order_id']) && isset($this->request->post['discount']))
        {
            ...
            $result = $this->model_sale_order->updateOrderTotalDiscount($order_id, $discount);
