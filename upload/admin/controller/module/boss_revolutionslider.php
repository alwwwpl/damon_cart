...
class ControllerModuleBossRevolutionSlider extends Controller {
	...
	public function index() {   
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('module/boss_revolutionslider', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], 'SSL')
			);			
		}		
	...
	public function sliderlist(){
		...
		if(isset($this->request->get['module_id'])){
			$data['action'] = $this->url->link('module/boss_revolutionslider/setting', 'token=' . $this->session->data['token'].'&module_id=' . $this->request->get['module_id'], 'SSL');

			$data['cancel'] = $this->url->link('module/boss_revolutionslider', 'token=' . $this->session->data['token'].'&module_id=' . $this->request->get['module_id'], 'SSL');
		
			$data['slider_form'] = $this->url->link('module/boss_revolutionslider/sliderform', 'token=' . $this->session->data['token'].'&module_id=' . $this->request->get['module_id'], 'SSL');
			...
			$data['modulesetting'] = $this->url->link('module/boss_revolutionslider/moduleSetting', 'token=' . $this->session->data['token'].'&slider_id='.$this->request->get['slider_id'], 'SSL');
		
			$data['new_slide'] = $this->url->link('module/boss_revolutionslider/sliderform', 'token=' . $this->session->data['token'].'&slider_id='.$this->request->get['slider_id'].'&slide_id=0', 'SSL');
		}
		$data['token'] = $this->session->data['token'];
	...
	public function sliderform(){
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if(isset($this->request->get['module_id'])){
				...
				$this->response->redirect($this->url->link('module/boss_revolutionslider/sliderlist', 'token=' . $this->session->data['token'].'&slider_id='.$slider_id, 'SSL'));
			}
		}
		...
		if(isset($this->request->get['module_id'])){
			...
			$data['action'] = $this->url->link('module/boss_revolutionslider/sliderForm', 'token=' . $this->session->data['token'].'&slide_id='.$slide_id.'&slider_id='.$slider_id, 'SSL');
		}
