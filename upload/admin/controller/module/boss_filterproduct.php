...
class ControllerModuleBossFilterProduct extends Controller {
	...
	public function index() {   
		...
		if (isset($this->error['error_character'])) {
			$data['error_character'] = $this->error['error_character'];
		} else {
	...
	private function validate() {
		...
		if (isset($boss_filterproduct_module)) { 			
			...
			if (!$boss_filterproduct_module['character']) { 
				$this->error['error_character'] = $this->language->get('error_character');
			}
