...
<div id="content">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr data-order="<?php echo $order['order_id']; ?>">
                  ...
                  <td class="text-right"><?php echo $order['distribute_id'] > 0 ? '含分销订单' : '普通订单'; ?></td>
                  <td class="text-right" style="width: 200px;"><a href="javascript:void(0);" class="discount" data-discount="<?php echo round($order['discount'],2); ?>">折扣 </a> <?php echo round($order['discount'],2); ?></td>
  ...
  <script type="text/javascript">
        $(document).on('click','.discount',function(){
            ...
            $(this).parent().html('<input type="text" value="'+discount+'" style="width:60px; text-align="center""> <a href="javascript:void(0);" class="discount-complete">完成</a> <a href="javascript:void(0);" class="discount-cancel">取消</a>');
        });

        $(document).on('click','.discount-complete',function(){
            ...
            $.post('index.php?route=sale/order/discount&token=<?php echo $token; ?>',{order_id:order_id,discount:discount},function(data){
                if (data.status == 'success')
                {
                    self.parent().html('<a href="javascript:void(0);" class="discount" data-discount="'+discount+'">折扣 </a> '+discount);
                }
                else
                {
                    alert(data.status);
          ...
          $(document).on('click','.discount-cancel',function(){
            ...
            $(this).parent().html('<a href="javascript:void(0);" class="discount" data-discount="'+discount+'">折扣 </a> '+discount);
