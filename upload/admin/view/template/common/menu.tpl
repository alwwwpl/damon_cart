<ul id="menu">
  ...
  <li id="sale"><a class="parent"><i class="fa fa-shopping-cart fa-fw"></i> <span><?php echo $text_sale; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $gold;?>"><?php echo $text_gold; ?></a> </li>
      <li><a href="<?php echo $customised;?>"><?php echo $text_customised; ?></a> </li>
      <li><a href="<?php echo $coupons;?>"><?php echo $text_coupons; ?></a> </li>
    </ul>
  </li>
