...
{
	//微信APPID
   	var $app_id="wx3cce59eef0ef6a5f";
    //微信秘钥
    var $app_secret="aedf1fcf8ddd7bb941dd90afa921c9f1";
    //跳转链接
    var $redirect_url="http://mp.weixin.qq.com/s?__biz=MzIwNTA0NjYyMA==&mid=210659989&idx=1&sn=d45782c24eea023466875cc84a43205a#rd";
    //传递的方式
    var $scope="";
    var $state=1;
    //用户同意授权，获取code
