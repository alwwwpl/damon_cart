...
<!--start-->
  <table width="100%" cellspacing="0" id="mytable">
    <thead>
		...
		<th width="*" align="center">个数</th>
		<th width="*" align="center">几率</th>
		<th width="*" align="center">最小角度</th>
		<th width="*" align="center">最大角度</th>
		</tr>
    </thead>
    <tbody>
		...
		<tr>
			...
			<td align="center">
				<input type="text" name="text" value="<?php echo $v['text'];?>">
			</td>
			<td align="center">
				<select name="award_name">
					<option value="0">请选择</option>
					<option value="score" <?php if($v['field'] == 'score')echo 'selected';?>>福分</option>
...
<script>
	$('#mytable tbody input').blur(function (){
		$.post("<?php echo WEB_PATH; ?>/zhuanpan/zhuanpan_admin/save",{
