  ...
  <table width="100%" cellspacing="0">
    <thead>
  	...
  	<tbody>
        ...
        <tr>
		<td align="left" width="50%">&nbsp;&nbsp;<a href="/?/goods/<?php echo $p['gid']; ?>" target="_blank" title="点击查看此商品准备测试信息"><?php echo $p['gtitle']; ?></a></td>	
		<td align="left" width="20%"><a href="/?/userbuy/<?php echo $p['uid']; ?>" target="_blank" title="点击查看此会员准备测试信息"><?php echo $p['utitle']; ?></a></td>	
