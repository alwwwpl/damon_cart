...
//福分、经验添加			
	...
	public function userrechargedk(){
		$member=$this->userinfo;
		$title="点卡充值";
		$paylist = $this->db->GetList("SELECT * FROM `@#_pay` where `pay_start` = '1' and `pay_id`='10'");	
	...
	public function waprechargedk(){
		$member=$this->userinfo;
		$title="点卡充值";
		$paylist = $this->db->GetList("SELECT * FROM `@#_pay` where `pay_start` = '1' and `pay_id`='11'");	
