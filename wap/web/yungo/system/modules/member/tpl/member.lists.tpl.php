...
<div class="lr10" style="line-height:30px;color:#f60">
	<b>会员列表:</b> <?php echo $select_where; ?> &nbsp;&nbsp;&nbsp; 共找到 <?php echo $total; ?> 个会员；点击会员ID可查看该会员的购买、晒单、中奖记录。
</div>
  ...
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
			...
			<th align="center">登陆时间,地址,IP,活动记录</th>
    ...
    <tbody>
    	<?php foreach($members as $v){ ?>
			<tr>
				<td align="center"><a title="查看该会员的购买、晒单、中奖记录" target="_blank" href="/?/uname/<?php echo $v['uid']; ?>"><?php echo $v['uid']; ?></a></td>
				...
				<td align="center"><?php echo _put_time($v['login_time'],"未登录"); ?>,<?php echo trim($v['user_ip'],","); ?>,<font color="#0c0"> <a style="line-height:30px;color:#f60" title="查看该会员的购买、晒单、中奖记录" target="_blank" href="/?/userbuy/<?php echo $v['uid']; ?>">活动记录</a></font></td>	
