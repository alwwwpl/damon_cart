...
<!-- 内页顶部 -->
        ...
        <section class="clearfix g-share-lucky">
			...
			<div class="u-lucky-r">
				<p>夺宝币兑换者：<a href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $shaidan['sd_userid']; ?>" class="z-user blue"><?php echo userid($shaidan['sd_userid'],'username'); ?></a></p>
				<p>兑换数量：<em class="orange"><?php echo get_user_jf_goods_num($shaidan['sd_userid'],$shaidan['sd_jfshopid']); ?></em>件</p>
