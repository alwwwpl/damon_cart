...
<div class="part4 ">
	...
	<dl class="activeRegulation fl">
		<dt>活动规则：</dt>
		<dd>
			<i>1</i>您每邀请一位好友成功参与<?php echo _cfg('web_name_two'); ?>即可获得50福分。
		</dd>
		<dd>
		...
		<dd>
			<i>4</i>在【我的个人中心】的【佣金明细】里可看到您的每次返现记录。佣金满100及以上可申请提现，任何时候都可充值到<?php echo _cfg('web_name_two'); ?>帐户。
		</dd>
		<dd>
			<i>5</i>对于查实的作弊行为，扣除一切佣金，取消邀请佣金的资格并清除您的福分账户。借助网站及其他平台，恶意获取佣金，一经查实，扣除一切佣金，清除福分账户且封号。
		</dd>
	...
	<div class="part4-layB fr">
		...
		<?php  else: ?>	
		    ...
		    <div class="Invitation-C1">
			    <p class="fs14">这是您的专属邀请链接或发送二维码，请通过 MSN 或 QQ 发送给您的好友</p>
				<p class="fs14"><div id="qrcodeTable"></div></p>
			    <div class="">
			    <textarea  name="copyShareText" style="margin: 0px; width: 432px; height: 118px;" id="fe_text" class="textarea">我刚发现一个很好玩的网站，1元就能买IPhone 6哦，快去看看吧！<?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>
</textarea>
			    </div>	   
...
<script type="text/javascript" src="<?php echo G_TEMPLATES_STYLE; ?>/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="<?php echo G_TEMPLATES_STYLE; ?>/js/jquery.qrcode.js"></script> 
<script type="text/javascript" src="<?php echo G_TEMPLATES_STYLE; ?>/js/qrcode.js"></script> 
<style type="text/css">
...
$(document).ready(function(){
	...
	$("#qrcodeTable").qrcode({
		render	: "table",
		text	: "<?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>",
		width:"200",
		height:"200"
	});	
		    ...
		    <div class="Invitation-C2">
			    <p class="fs14">通过分享邀请好友，分享到您的QQ、人人、开心、微博上的朋友吧！</p>
       ...
       <div class="R-content">
            <div class="member-t"><h2>分享好友</h2></div>
...
<script>
	window._bd_share_config = {
		common : {
			//bdText : '自定义分享内容',	
			//bdDesc : '自定义分享摘要',	
			bdUrl : '<?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>', 	
		//	bdPic : '自定义分享图片'
		},
		share : [{
			"bdSize" : 16
