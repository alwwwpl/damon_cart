...
<head>
    ...
    <link href="<?php echo G_TEMPLATES_CSS; ?>/mobile/comm.css?v=130715" rel="stylesheet" type="text/css" /><link href="<?php echo G_TEMPLATES_CSS; ?>/mobile/member.css?v=130726" rel="stylesheet" type="text/css" /><script 
	src="<?php echo G_TEMPLATES_JS; ?>/mobile/jquery190.js" language="javascript" type="text/javascript"></script>
</head>
<body>
	...
	border-radius: 2px;
        ...
        <div class="registerCon">
	        <ul>
				...
				<p>3.如果手机号码不小心输错了或者想换个号码？请点击 <a id="hylinkRegisterPageA" class="blue Fb" href="<?php echo WEB_PATH; ?>/mobile/user/register">重新注册</a></p>
				</li>
			</ul>
        </div>
		</form>
...
<script>
	...
	function sendmobile(){
		window.location.href="<?php echo WEB_PATH; ?>/mobile/finduser/findsendmobile/<?php echo $namestr; ?>"
	}
</script>
</div>
</body>
