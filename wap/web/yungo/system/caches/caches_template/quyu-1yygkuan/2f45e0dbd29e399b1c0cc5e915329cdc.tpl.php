...
$("#grsz").attr('class','sid-icon09 sid-hcur');
$(function(){		
...
<div class="R-content">
    ...
    <?php if($member['email']==null || $member['username']==null): ?>
		<div class="prompt orange" style="margin-top: 3px;">"新用户完善昵称，即可得到完善昵称赠送的200福分！绑定手机和邮箱，又可以免费赠送200福分，福分可以免费参与云购哦！"<s></s></div>
	<?php endif; ?>
