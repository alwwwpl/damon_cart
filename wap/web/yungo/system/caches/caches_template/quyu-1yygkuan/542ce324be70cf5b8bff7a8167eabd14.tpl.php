				...
				<div class="GetPrize">				    
					<dl>
						...
						<dd class="gray02">
							...
							<p>欢乐<?php echo _cfg('web_name_two'); ?>码：<em class="orange Fb"><?php echo $sid_code['q_user_code']; ?></em></p>
						</dd>
					</dl>				
				</div>
			</div>
		...
		<div class="Pro_Detright">
			...
			<div class="Pro_Record">
				...
				<div class="Newest_Con hide" style="display:none;">
					<p class="MsgIntro"><?php echo _cfg("web_name_two"); ?>购是指只需1元就有机会买到想要的商品。即每件商品被平分成若干“等份”出售，每份1元，当一件商品所有“等份”售出后，根据<?php echo _cfg('web_name_two'); ?>规则产生一名欢乐者，该欢乐者即可获得此商品。</p>
