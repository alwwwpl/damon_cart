			...
			<div class="share_goods">
				<div class="share-get">
					...
					<div class="share-getinfo">
						<p class="getinfo-name">欢乐获得者：<a class="blue Fb" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($shaidan['sd_userid']); ?>" target="_blank"><?php echo userid($shaidan['sd_userid'],'username'); ?></a></p>
						<p>总共<?php echo _cfg('web_name_two'); ?>：<b class="orange"><?php echo get_user_goods_num($shaidan['sd_userid'],$shaidan['sd_shopid']); ?></b>人次</p>
						<?php 
						$jikxiao = get_shop_if_jiexiao($shaidan['sd_shopid']);						
						 ?>
						<?php if($jikxiao['q_uid']): ?>
						<p>欢乐<?php echo _cfg('web_name_two'); ?>码：<?php echo $jikxiao['q_user_code']; ?>	</p>
				...
				<div class="share-Conduct">
					...
					<div class="share-getinfo">
						<p class="getinfo-title"><a class="gray01" href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $jikxiao['id']; ?>" target="_blank">(第<?php echo $jikxiao['qishu']; ?>期)<?php echo $jikxiao['title']; ?></a></p>
						<p>价值：￥<?php echo $jikxiao['money']; ?></p>
