		...
		<ul class="order_list">
            ...
            <?php if($fufen_dikou): ?>
			 <li id="liPayByPoints" class="point_out">
					...
					<input type="checkbox" class="input_choice" id="shop_score" name="shop_score" value="1"/>使用积分抵扣现金：您的积分(<?php echo $member['score']; ?>)本次消费最多可抵扣现金
                    <span class="orange Fb"><?php echo $fufen_dikou; ?>.00</span>元)，我要使用 
                    <input type="text" maxlength="8" class="pay_input_text_gray" id="shop_score_num" value="0" money="<?php echo $fufen['fufen_yuan']; ?>" name="shop_score_num"/> 积分, 1元 = <?php echo $fufen['fufen_yuan']; ?> 积分</div>
             ...
             <?php  else: ?>
              <li id="liPayByPoints" class="point_out point_gray">
					<div class="payment_List_Lc">
					<input type="checkbox" class="input_choice" disabled="disabled"/>使用积分抵扣现金：您的福分(<?php echo $member['score']; ?>)本次消费最多可抵扣现金
                    <span class="orange Fb"><?php echo $fufen_dikou; ?>.00</span>元)，我要使用 
                    <input type="text" maxlength="8" class="pay_input_text_gray" name="costPoint"  disabled="disabled"/> 积分</div>
                    <p id="pPointsTip" class="pay_Value" style="display:none;"></p>
                    <p class="payment_List_Rc"></p>
              </li>
             <?php endif; ?>
