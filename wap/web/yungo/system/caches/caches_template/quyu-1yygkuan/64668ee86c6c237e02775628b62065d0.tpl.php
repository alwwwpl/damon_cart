...
<table class="address-list">
    ...
    <tr>
        <ul>
            ...
            <td><a class="blue" href="<?php echo WEB_PATH; ?>/mobile/home/morenaddress/<?php echo $v['id']; ?>">默认</a></td>
            <td><a onclick="dell(<?php echo $v['id']; ?>)"  href="javascript:;" >删除</a></td>
            <?php if($v['default']=='Y'): ?><?php  else: ?>
            <?php endif; ?>
        </ul>
