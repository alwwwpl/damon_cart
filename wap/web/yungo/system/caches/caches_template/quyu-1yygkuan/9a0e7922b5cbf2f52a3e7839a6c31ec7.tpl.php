    ...
    <section class="goodsCon pCon">
        ...
        <div class="pProcess pProcess2">
    	    <div class="pResults">
        	    ...
        	    <div class="pResultsR">
                    <div class="g-snav">
                        <div class="g-snav-lst">总共夺宝<br><dd><b class="orange"><?php echo $gorecode['gonumber']; ?></b><br>人次</dd></div>
                        <div class="g-snav-lst">揭晓时间<br><dd class="gray9"><span><?php echo str_replace(' ','<br>',microt($item['q_end_time'])); ?></span></dd></div>
                        <div class="g-snav-lst">夺宝时间<br><dd class="gray9"><span><?php echo str_replace(' ','<br>',microt($gorecode['time'])); ?></span></dd></div>
                    </div>
                </div>
        	    <p><a href="<?php echo WEB_PATH; ?>/mobile/mobile/calResult/<?php echo $item['id']; ?>" class="fr">查看计算结果</a>幸运夺宝码：<b class="orange"><?php echo $item['q_user_code']; ?></b></p>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="joinAndGet">
    	    <dl>
    	        <a href="<?php echo WEB_PATH; ?>/mobile/mobile/buyrecords/<?php echo $item['id']; ?>"><b class="fr z-arrow"></b>所有夺宝记录</a>
		...
		<?php if($item['q_end_time'] !=''): ?>
			...
			<?php  else: ?>
                ...
                <li class="getInfo">
                    ...
                    <dd>总共聚购：<em class="orange arial"><?php echo $gorecode['gonumber']; ?></em>人次</dd>
                    <dd>幸运聚购码：<em class="orange arial"><?php echo $gorecode['huode']; ?></em></dd>
                    <dd>揭晓时间：<?php echo microt($itemlist[0]['q_end_time']); ?></dd>								   
                    <dd>聚购时间：<?php echo microt($gorecode['time']); ?></dd>
                </li>
            </ul>
			 <?php endif; ?>
			<?php endif; ?>
