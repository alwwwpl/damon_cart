 ...
 <div class="g-toolbar">
     <div class="w1190">
         ...
         <ul class="fl">
             ...
             <li>
                 <div class="u-menu-hd">
                     <a href="<?php echo WEB_PATH; ?>/go/index/weixin" target="_blank" title="关注微信">关注微信</a>
                 </div>
             </li>
              <li class="f-gap"><s></s></li>
             <li>
...
<a title="我的{wc:fun:_cfg('web_name_two')购" href="<?php echo WEB_PATH; ?>/member/home/">我的<?php echo _cfg('web_name_two'); ?></a>
                 ...
                 <div class="u-select u-select-my">
                     ...
                     <span><a href="<?php echo WEB_PATH; ?>/group" title="<?php echo _cfg('web_name_two'); ?>圈子"><?php echo _cfg('web_name_two'); ?>圈子</a></span>
                 </div>
             </li>
             <li class="f-gap"><s></s></li>
