...
<div class="login_layout">
	...
	<div class="prompt orange" style="position: absolute;margin: 20px 0 0 140px;border: 1px solid #FD9;">“新注册的用户，注册都可以免费赠送一次<?php echo _cfg('web_name_two'); ?>机会，有机会获得iphone5s、笔记本电脑、平板电脑、单反哦!”<s></s></div>
