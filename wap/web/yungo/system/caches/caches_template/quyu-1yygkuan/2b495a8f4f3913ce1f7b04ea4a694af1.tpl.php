...
<html>
<head>
    <title>分享晒单 - <?php echo _cfg("web_name_two"); ?>触屏版</title>
...
<script type="text/javascript" charset="utf-8" src="<?php echo G_PLUGIN_PATH; ?>/ueditor/ueditor.all.min.js"></script>
	...
	<script src="<?php echo G_TEMPLATES_JS; ?>/patch/localResizeIMG.js" charset="utf-8" type="text/javascript"></script>
	
    <!-- mobileBUGFix.js 兼容修复移动设备 -->
	<script src="<?php echo G_TEMPLATES_JS; ?>/patch/mobileBUGFix.mini.js" charset="utf-8" type="text/javascript"></script>
<script>
//上传文件
$(function(){
    $('#sd_file').uploadify({
        ...
        'method'   : 'post',
		'buttonText' : '选择图片',
		'buttonImage': '<?php echo G_PLUGIN_PATH; ?>/uploadify/select.ng',
		'width': 120,
		'height': 30,
        'multi'    : true,
		'uploadLimit' : 10,
	...
	<section>
		<div class="registerCon">
			<form method="post" enctype="multipart/form-data">
				<ul class="form">
        	        <li>
						商品：<?php echo $ginfo['title']; ?>
						<a target="_blank" href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $ginfo['id']; ?>" class="blue">[查看]</a>
                    </li>
        	        <li>
