...
<div class="n-h-tit"><h1 class="header-logo">个人主页</h1></div>
</div>
</header>
   ...
   <section>
	<div class="mainCon">
    	<div class="mBanner">
        	<ul>
            	<li class="mUserHead"><img src="<?php echo G_UPLOAD_PATH; ?>/<?php echo $member['img']; ?>"></li><li class="mUserInfo"><p><?php echo get_user_name($member['uid']); ?></p><br/>夺宝币：<?php echo $member['score']; ?><br/>经验值：<?php echo $member['jingyan']; ?><span class="z-class-icon03"><s></s><?php echo $member['yungoudj']; ?></span></li>
            </ul>
        </div>
