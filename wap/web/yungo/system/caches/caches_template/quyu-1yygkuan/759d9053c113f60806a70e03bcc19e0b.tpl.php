<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="Progress-bar">
				...
				if(endtime <= this.this_time){			
					...
					$.post("<?php echo WEB_PATH; ?>/go/autolottery/autolottery_ret_install",{"shopid":<?php echo $item['id']; ?>},function(data){		
						...
						if(data == '-5'){
							...
							xsjx_time_shop.html("<b>限时揭晓</b><p>揭晓欢乐码:<i style='color:#fff;background:#f60; padding:3px 5px;'>"+data+"</i></p>");						
							return;
						}						
			...
			<p class="Pro_Detsingle" style="font-size:14px;"><?php echo _cfg('web_name_two'); ?>价格：<b style="color:#999;"><?php echo $item['yunjiage']; ?></b></p>
			<div id="divNumber" class="Pro_number">
				我要<?php echo _cfg('web_name_two'); ?> 
			...
			<div id="divBuy" class="Det_button">
                ...
                <?php  else: ?>
				<a href="javascript:;" class="Det_Shopbut">立即<?php echo _cfg('web_name_two'); ?></a>
                <?php endif; ?>
