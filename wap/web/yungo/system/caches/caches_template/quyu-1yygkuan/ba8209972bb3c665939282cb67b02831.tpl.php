...
<div class="center">
	<div class="per-info">
 	...
 	<li class="account-money">
		...
		福分：<span class="money-red"><em><?php echo $member['score']; ?></em></span> <span class="c-999">（福分可以购物使用）</span></h5>
	...
	<h5>我的邀请：［邀请好友： 100福分 5经验］ <a class="c-999" target="_blank" href="<?php echo WEB_PATH; ?>/member/home/invitefriends" hidefocus="true">赶紧邀请去&gt;&gt;</a> </h5>
...
<div class="right">				
	...
	<!-- <div class="gg-content">
		...
		<ul class="gg-list">	
			<li><span class="point"></span><span class="info"><a href="http://group.1yyg.com/Topic-621.html" target="_blank" class="gray" title="关于“欢乐闪购码”计算结果错误的公告">关于“欢乐闪购码”计算结果错误的公告</a></span></li>
		</ul>
	</div> -->
</div>
<!--center_rjght_end-->
