...
<div class="n-h-tit"><h1 class="header-logo">充值大抽奖</h1></div>
</div>
</header>
    	    ...
    	    <div class="helpMain m-round">
        	    <div class="helpInfo">
            	    <dt>
                	    <h3>
							...
							<span class="z-Recharge-btn">
								<a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge" class="z-Recharge-btn">充值</a>
								<?php if(!$this->userinfo): ?>
									<a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge" class="z-Recharge-btn">登录</a>
								<?php endif; ?>
							</span>
						</h3>
                    </dt>
                    ...
                    <dd class="helpBox" id="lottery_tips">
						<?php 
						if ( !$this->userinfo ){
							echo '您还没有<a class="blue" href="<?php echo WEB_PATH; ?>/mobile/user/login">登录</a>，无法参与抽奖哦';
	    ...
	    <div class="helpCon">
    	    <div class="helpMain m-round">
        	    <div class="helpInfo">
                    ...
                    <dd class="helpBox">
						1. 活动时间: 2015/7/1 - 2015/9/30<br>
						2. 活动内容：在活动时间内，所有注册会员购买商品，做任务得到福分满1000获得一次抽奖机会哦！<br>
						3. 活动奖品：<br>
							&nbsp; &nbsp; 一等奖: <b class="orange">10元</b> 云购红包<br>
							&nbsp; &nbsp; 二等奖: <b class="orange">8元</b> 云购红包<br>
							&nbsp; &nbsp; 三等奖: <b class="orange">6元</b> 云购红包<br>
							&nbsp; &nbsp; 四等奖: <b class="orange">4元</b> 云购红包<br>
							&nbsp; &nbsp; 五等奖: <b class="orange">3元</b> 云购红包<br>
							&nbsp; &nbsp; 六等奖: <b class="orange">2元</b> 云购红包<br>
							&nbsp; &nbsp; 七等奖: <b class="orange">1元</b> 云购红包。<br>
						4. 活动说明：活动中奖率<b class="orange">100%</b>，用户获奖后云购红包将直接充值至用户余额内，红包金额不得提现。<br>
