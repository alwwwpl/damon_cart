...
<div class="show_content">
	...
	<div class="Pro_Details">
		...
		<div class="Pro_Detright">
				...
				<div class="Announced_FrameGet">
					<dl>
						<dd class="gray02">
							...
							<p><?php echo _cfg('web_name_two'); ?>时间：<?php echo microt($user_shop_time); ?></p>
						</dd>
					</dl>
				</div>
			...
			<div class="MaCenter">
				<p>商品获得者本期总共<?php echo _cfg('web_name_two'); ?>了<em class="orange"><?php echo $user_shop_number; ?></em>人次</p>
	...
	<div id="divCalResult" class="Product_Content">	
		<div class="ygRecord" name="div_tab">
				<div class="yghelp">
					...
					<br>
					3、将这100个数值之和除以该商品总参与人次后取余数，余数加上10000001 即为“欢乐<?php echo _cfg('web_name_two'); ?>码”。
					<?php if(!$item['q_content']): ?>
					<br>
					<b>由于网站还未满100条购买记录。所以按照   10000001 + (揭晓时间求和结果*100/参与人数) 的余数   即为“欢乐<?php echo _cfg('web_name_two'); ?>码”。</b>
					<?php endif; ?>
				</div>
