...
<div class="n-h-tit"><h1 class="header-logo">登录</h1></div>
</div>
</header>
        ...
        <section>
	        <div class="registerCon">
    	        ...
    	        <ul>
                    ...
                    <li class="rSelect">
                        <a href="<?php echo WEB_PATH; ?>/mobile/user/findpassword">&nbsp忘记密码？</a>
                        <b></b><a href="<?php echo WEB_PATH; ?>/mobile/user/register">新用户注册</a></li>
					</br></br>
				<!-- 直接使用合作账号登录 -->
				<!--<div class="other-login-outer">-->
				<!--<ul class="coo_login clearfix">-->
                <!--<li><a href="<?php echo WEB_PATH; ?>/api/wapqqlogin" class="coo_a coo_qq"></a></li>-->
