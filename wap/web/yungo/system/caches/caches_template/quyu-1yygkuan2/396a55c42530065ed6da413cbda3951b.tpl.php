...
<div class="n-h-tit"><h1 class="header-logo">我的<?php echo _cfg('web_name_two'); ?></h1></div>
 ...
 <li><a href="<?php echo WEB_PATH; ?>/mobile/invite/address"><b class="z-arrow"></b>会员名修改</a></li>
  <li><a href="<?php echo WEB_PATH; ?>/mobile/home/password"><b class="z-arrow"></b>密码修改</a></li>
