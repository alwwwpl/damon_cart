            ...
            var w = function() {
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        var A = "";
                        for (var y = 0; y < B; y++) {
                            var z = C[y].sd_checked;
                            var x = Gobal.Webpath+"/mobile/shaidan/detail/" + C[y].sd_id ;
                            ...
                            if (z == 0) {
                                A += '<p><span class="">正在等待审核</span></p>'
                            } else {
                                if (z == -1) {
                                    A += '<p><span class="red">审核未通过</span></p>'
                                } else {
                                    if (z == 1) {
                                        A += '<p><span class="green">审核通过，奖励'+C[y].sd_checkFufen+'福分</span></p>'
                                    }
                                }
                            }
            ...
            var w = function() {
                ...
                function(B) {
                    if (B.code == 0) {
                        ...
                        for (var x = 0; x < z; x++) {
                            var xx = Gobal.Webpath+"/mobile/home/singleinsert/" + A[x].id ;
                            var C = '<li class="' + (x + 1 == z ? "bornone": "") + '" onclick="location.href=\'' + xx + '\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + A[x].id + '"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + A[x].thumb + '" border=0 alt=""></a><div class="u-sgl-r gray9"><p class="z-sgl-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + A[x].id + '" class="gray6">' + A[x].title + "</a></p><p>欢乐挖宝码：" + A[x].q_user_code + "</p><p>揭晓时间：" + A[x].q_end_time + '</p><p><a href="javascript:void(0);" class="z-gds-btn">去晒单</a></p></div><b class="z-arrow"></b></li>';
                            s.append(C)
                        }
