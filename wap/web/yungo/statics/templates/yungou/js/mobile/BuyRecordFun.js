        ...
        var n = function() {
            ...
            function(r) {
                if (r.Code == 0) {
                    ...
                    var p = q.length;
                    for (var o = 0; o < p; o++) {
                        s += '<ul><li class="rBg"><a href="/?/mobile/mobile/userindex/' + q[o].uid + '"><img src="/statics/uploads/' + q[o].uphoto + '"><s></s></a></li><li class="rInfo"><a href="http://m.yyg001.com/userpage/' + q[o].uid + '">' + q[o].username + "</a><strong>(" + q[o].ip+ ')</strong><br><span>购买了<b class="orange">' + q[o].gonumber + '</b>人次</span><em class="arial">' + q[o].buyTime + "</em></li><i></i></ul>"
                    }
                    d.append(s);
                    if (i.EIdx < a) {
                        j.show()
