...
$chinapay_orderid = date('YmdHis');

$_SESSION['chinapay_'.$chinapay_orderid] = $_SESSION['OrderId'];

$orderNo = $chinapay_orderid;
?>
<div style="display: none;">
<form name="createOrder" action="/cart/china-pay-sign" method="POST" id="chinapay">
    <table>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="MerId" value="481601511191020" maxlength="15"> &nbsp;(15位数字，由chinapay分配)
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="OrderAmt" value="<?php echo $total; ?>" maxlength="12"> &nbsp;(1-12位数字，不填默认金额为1分)
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="TranTime" value="<?php echo date('Hms'); ?>" maxlength="8"> &nbsp;(6位数字，为订单提交时间)
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="MerPageUrl" value="http://<?php echo  $_SERVER['HTTP_HOST'];?>/cart/china-pay-pg-return" maxlength="80"> &nbsp;(不超过80字节，商户系统前台应答接受地址)
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" name="MerBgUrl" value="http://<?php echo  $_SERVER['HTTP_HOST'];?>/cart/china-pay-bg-return" maxlength="80"> &nbsp;(不超过80字节，商户系统后台应答接受地址)
            </td>
        </tr>
