...
<div id="product">
    ...
    <div class="form-group cart">
        ...
        <div class="cart_button">
            <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn button_cart" style="float: left;"><?php echo $button_cart; ?></button>
            <button type="button" id="button-carts" data-loading-text="<?php echo $text_loading; ?>" class="btn" style="float: left; margin-left:20px; background-color: #FFF; border: 1px solid #FD4F4E; color:#FD4F4E;">立即购买</button>
        </div>
        <div class="btn-group">
            ...
            <?php if ($isLogged){
                    ?>
            <button type="button" class="btn-shop" data-product="<?php echo $_GET['product_id'];?>" title="加入我的店铺" ><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 加入店铺</button>
            <?php
                    } ?>
        </div>
...
<script type="text/javascript"><!--
    ...
    $('.btn-shop').on('click',function(){
        ...
        if (product_id)
        {
            var supplier_id = '<?php echo isset($_GET['supplier_id']) ? $_GET['supplier_id'] : 0;?>';
            $.post('index.php?route=account/product_distribute/add',{product_id:product_id,price:0,supplier_id:supplier_id},function(data){
