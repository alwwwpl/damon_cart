          ...
          <div id="product">
            ...
            <div class="form-group cart">
			  ...
			  <div class="price_info">
				...
				<div class="btn-group">
					<button type="button" data-toggle="tooltip" class="btn-wishlist" title="<?php echo $button_wishlist; ?>" onclick="btadd.wishlist('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></button>
					<button type="button" data-toggle="tooltip" class="btn-compare" title="<?php echo $button_compare; ?>" onclick="btadd.compare('<?php echo $product_id; ?>');"><i class="fa fa-arrow-down"></i><?php echo $button_compare; ?></button>
				</div>				
