...
<div class="container">
  ...
  <?php } ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal account_form">
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div>
              <input type="email" style="float: left;" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" disabled/> <a href="#" style="margin: 17px; float: left;">邮箱验证</a>
              <?php if ($error_email) { ?>
          ...
          <div class="form-group required">
            ...
            <div>
              <input type="tel" name="telephone" style="float: left;" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" disabled/> <a href="#" style="margin: 17px; float: left;">手机验证</a>
          ...
          <div class="form-group required">
              <label class="control-label" for="input-payment_password">支付密码</label>
              <div>
                  <input type="password" name="payment_password" style="float: left;" value="<?php echo $payment_password; ?>" placeholder="支付密码" id="input-payment_password" class="form-control"/>
                  <?php if ($error_payment_password) { ?>
                  <div class="text-danger"><?php echo $error_payment_password; ?></div>
                  <?php } ?>
              </div>
          </div>
