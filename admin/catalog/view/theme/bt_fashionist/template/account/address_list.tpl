  ...
  <?php } ?>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="text-right"><a href="<?php echo $result['update']; ?>" class="btn"><?php echo $button_edit; ?></a> &nbsp; <a href="<?php echo $result['delete']; ?>" class="btn btn-shopping"><?php echo $button_delete; ?></a></td>
        </tr>
        <?php } ?>
      </table>
      <?php } else { ?>
