<form class="form-horizontal">
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
      <div class="form-group required" style="display: none">
          ...
          <div>
              <input type="text" name="firstname" value="0" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
          </div>
      </div>
  ...
  <div class="buttons clearfix">
    <div class="pull-left">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn" />
    </div>
  </div>
</form>
