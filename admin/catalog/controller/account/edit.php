...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['payment_password'])) {
            $data['error_payment_password'] = $this->error['payment_password'];
        } else {
            $data['error_payment_password'] = '';
        }
        ...
        if (isset($this->request->post['payment_password'])) {
            $data['payment_password'] = $this->request->post['payment_password'];
        } elseif (!empty($customer_info)) {
            $data['payment_password'] = $customer_info['payment_password'];
        } else {
