...
class ControllerModuleBossFeatured extends Controller {
	public function index($setting) {
		...
		if(isset($setting['show_pro_large']) && $setting['show_pro_large']){
			...
			$product_info = $this->model_catalog_product->getProduct($product_id, '', $city);
			...
			if (!empty($product_info)) {
				...
				$mainproduct = array(
					...
					'href'    	 => $this->url->link('product/product', 'product_id=' . $product_info['product_id'] . $supplier_id),
				);
			}
		}
		...
		if ($setting['type_product'] == "popular") {
			$results = $this->model_catalog_product->getPopularProducts($limit, $city, $parent);
		}
		...
		if ($setting['type_product'] == "best_seller") {
			$results = $this->model_catalog_product->getBestSellerProducts($limit, $city, $parent);
		}
		if ($setting['type_product'] == "latest") {
			$results = $this->model_catalog_product->getLatestProducts($limit, $city, $parent);
		}
