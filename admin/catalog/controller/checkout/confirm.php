...
class ControllerCheckoutConfirm extends Controller {
	public function index() {
		...
		if (!$redirect) {
            ...
            $order_data['distribute_id'] = $parent;
			$order_data['products'] = array();

			foreach ($this->cart->getProducts() as $product) {
				$option_data = array();
                $bidding = array();
                if (isset($product['bidding']) && $product['bidding'] == 'bidding')
                {
                    $bidding[$product['product_id']] = 'bidding';
                }
                else
                {
                ...
                if (isset($product['supplier_id']) && $product['supplier_id'] > 0)
                {
            ...
            $this->session->data['bidding'] = $bidding;
