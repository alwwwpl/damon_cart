...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/Library/WebServer/Documents/damon_cart/upload/upop/certs/PM_700000000000001_acp.pfx';

// 签名证书密码 
const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/Library/WebServer/Documents/damon_cart/upop/certs/verify_sign_acp.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/Library/WebServer/Documents/damon_cart/upop/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://iddmall.com/upop/FrontReceive.php';

// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'http://iddmall.com/upop/BackReceive.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/Library/WebServer/Documents/damon_cart/upload/upop/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/Library/WebServer/Documents/damon_cart/upload/upop/logs/';
