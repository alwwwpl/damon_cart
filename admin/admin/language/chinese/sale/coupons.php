...
// Column
$_['column_coupons_name']       = '优惠券名称';
$_['column_code']         = 'Code';
$_['column_discount']     = '折扣';
$_['column_start_time']   = '开始日期';
$_['column_over_time']     = '结束日期';
$_['column_status']       = '状态';
...
// Entry
$_['entry_coupons_name']        = '优惠券名称';
$_['entry_code']                = '代码';
$_['entry_condition']           = '总额';
$_['entry_discount']            = '折扣';
$_['entry_agent_id']            = '代理商';
$_['entry_product_category']    = '产品类别';
$_['entry_agent_percent']       = '占比(代理商)';
$_['entry_system_percent']      = '占比(商城)';
$_['entry_start_time']          = '开始日期';
$_['entry_over_time']           = '结束日期';


// Help
$_['help_code']           = '客户输入代码以获得折扣。';
$_['help_type']           = '百分比或固定金额。';
$_['help_logged']         = '客户必须先登录才能使用优惠券。';
$_['help_total']          = '在订单达到此金额以前不能使用优惠券。';
$_['help_category']       = '选择在所选类别的所有商品。';
$_['help_product']        = '选择优惠券适用于的具体商品。不选择商品则适用全店。';
