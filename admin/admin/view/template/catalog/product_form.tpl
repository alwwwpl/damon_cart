            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-supplier" data-toggle="tab">供货商</a></li>
                        ...
                        <li><a href="#tab-bidding" data-toggle="tab">抢拍</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-price">成本价格：</label>
                                <div class="col-sm-10">
                                    <input type="text" name="cost_price" value="<?php echo $cost_price; ?>" placeholder="成本价格" id="input-cost-price" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-price">采购价格：</label>
                                <div class="col-sm-10">
                                    <input type="text" name="price" value="<?php echo $price; ?>" placeholder="采购价格" id="input-price" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-price">会员价格：</label>
                                <div class="col-sm-10">
                                    <input type="text" name="vip_price" value="<?php echo $vip_price; ?>" placeholder="会员价格" id="input-vip-price" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab-supplier">
                            <div class="table-responsive">
                                <table id="supplier" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <td class="text-left">供货商</td>
                                        <td class="text-left">区域</td>
                                        <td class="text-left">产品名称</td>
                                        <td class="text-left">产品编号</td>
                                        <td class="text-left">产品库存</td>
                                        <td class="text-left">成本价</td>
                                        <td class="text-left">采购价</td>
                                        <td class="text-left">会员价</td>
                                        <td></td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr id="suppliers-row<?php echo $supplier_row; ?>">
                                        <td class="text-left">
                                            <select name="product_supplier[<?php echo $supplier_row; ?>][agent_id]" class="form-control supplier-option">
                                                <?php foreach ($agents as $agent) { ?>
                                                <?php if ($agent['agent_id'] == $product_supplier['agent_id']) { ?>
                                                <option value="<?php echo $agent['agent_id']; ?>" selected="selected" data-agent-name="<?php echo $agent['username'];?>" data-area="<?php echo $agent['area_name']; ?>"><?php echo $agent['username']; ?></option>
                                                <?php } else { ?>
                                                <option value="<?php echo $agent['agent_id']; ?>" data-agent-name="<?php echo $agent['username'];?>" data-area="<?php echo $agent['area_name']; ?>"><?php echo $agent['username']; ?></option>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                        </td>
                                        <input type="hidden" name="product_supplier[<?php echo $supplier_row; ?>][agent_name]" value="<?php echo $product_supplier['agent_name']; ?>" class="agent-name">
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][agent_area]" value="<?php echo $product_supplier['agent_area']; ?>" placeholder="区域" class="form-control area" readonly/></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][agent_product_name]" value="<?php echo $product_supplier['agent_product_name']; ?>" placeholder="产品名称" class="form-control"/></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][agent_product_model]" value="<?php echo $product_supplier['agent_product_model']; ?>" placeholder="产品编号" class="form-control"/></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][agent_product_stock]" value="<?php echo $product_supplier['agent_product_stock']; ?>" placeholder="产品库存" class="form-control"/></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][cost_price]" value="<?php echo $product_supplier['cost_price']; ?>" placeholder="成本价" class="form-control" /></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][price]" value="<?php echo $product_supplier['price']; ?>" placeholder="采购价" class="form-control" /></td>
                                        <td class="text-right"><input type="text" name="product_supplier[<?php echo $supplier_row; ?>][vip_price]" value="<?php echo $product_supplier['vip_price']; ?>" placeholder="会员价" class="form-control" /></td>
                                        <td class="text-left"><button type="button" onclick="$('#suppliers-row<?php echo $supplier_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                                    </tr>
                                    <?php $supplier_row++; ?>
                                    <?php } ?>
                                    </tbody>
                                    ...
                                    <tr>
                                        <td colspan="8"></td>
                                        <td class="text-left"><button type="button" onclick="addSupplier();" data-toggle="tooltip" title="<?php echo $button_discount_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-bidding">
                            <div class="table-responsive">
                                <table id="bidding" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <td class="text-left">开拍价格</td>
                                        <td class="text-left">竞拍底价</td>
                                        <td class="text-left">开始时间</td>
                                        <td class="text-left">结束时间</td>
                                        <td class="text-left">降价时间</td>
                                    ...
                                    <tbody>
                                    <tr id="bidding-row">
                                        <td class="text-left"><input type="text" name="product_bidding[bidding][start_price]" value="<?php if (isset($bidding['start_price'])) {echo $bidding['start_price'];}else{echo '';}?>" placeholder="" class="form-control" /></td>
                                        <td class="text-left"><input type="text" name="product_bidding[bidding][floor_price]" value="<?php if (isset($bidding['floor_price'])) {echo $bidding['floor_price'];}else{echo '';}?>" placeholder="" class="form-control" /></td>
                                        <td class="text-left" style="width: 20%;">
                                            <div class="input-group date">
                                                <input type="text" name="product_bidding[bidding][start_time]" value="<?php if (isset($bidding['start_time'])) {echo $bidding['start_time'];}else{echo '';}?>" placeholder="" data-date-format="YYYY-MM-DD HH:MM:ss" class="form-control" />
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                                            </span>
                                            </div>
                                        ...
                                        <td class="text-left" style="width: 20%;">
                                            <div class="input-group date">
                                                <input type="text" name="product_bidding[bidding][over_time]" value="<?php if (isset($bidding['over_time'])) {echo $bidding['over_time'];}else{echo '';}?>" placeholder="" data-date-format="YYYY-MM-DD HH:MM:ss" class="form-control" />
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                                            </span>
                                            </div>
                                        </td>
                                        <td class="text-left"><input type="text" name="product_bidding[bidding][interval]" value="<?php if (isset($bidding['interval'])) {echo $bidding['interval'];}else{echo '';}?>" placeholder="如 10 ,分钟为单位" class="form-control" /></td>
                                        <td class="text-left"><input type="text" name="product_bidding[bidding][stock]" value="<?php if (isset($bidding['stock'])) {echo $bidding['stock'];}else{echo '';}?>" placeholder="1" class="form-control" /></td>
                                        <td class="text-left">
                                            <input type="radio" name="product_bidding[bidding][status]" value="1" <?php if (isset($bidding['status'])) {echo $bidding['status'] == 1 ? 'checked' : '';}?>>上架<br>
                                            <input type="radio" name="product_bidding[bidding][status]" value="0" <?php if (isset($bidding['status'])) {echo $bidding['status'] == 0 ? 'checked' : '';}?>>下架
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
...
<script type="text/javascript">
    ...
    function addSupplier() {
        html  = '<tr id="supplier-row' + supplier_row + '">';
        html += '  <td class="text-left"><select name="product_supplier[' + supplier_row + '][agent_id]" class="form-control supplier-option">';
        html += '    <option value="0" data-area="选择供货商">选择供货商</option>';
        <?php foreach ($agents as $agent) { ?>
        html += '    <option value="<?php echo $agent['agent_id']; ?>" data-agent-name="<?php echo $agent['username'];?>" data-area="<?php echo $agent['area_name']; ?>"><?php echo addslashes($agent['username']); ?></option>';
        <?php } ?>
        html += '  </select></td>';
        html += '  <input type="hidden" name="product_supplier[' + supplier_row + '][agent_name]" value="" class="agent-name"> ';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][agent_area]" value="" placeholder="" class="form-control area" readonly/></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][agent_product_name]" value="" placeholder="" class="form-control"/></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][agent_product_model]" value="" placeholder="" class="form-control"/></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][agent_product_stock]" value="" placeholder="" class="form-control"/></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][cost_price]" value="" placeholder="" class="form-control" /></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][price]" value="" placeholder="" class="form-control" /></td>';
        html += '  <td class="text-right"><input type="text" name="product_supplier[' + supplier_row + '][vip_price]" value="" placeholder="" class="form-control" /></td>';
        html += '  <td class="text-left"><button type="button" onclick="$(\'#supplier-row' + supplier_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
        html += '</tr>';
        $('#supplier tbody').append(html);

        $('.date').datetimepicker({
            pickTime: false
        });

        $('#supplier .supplier-option').on('change',function(){
            var area = $(this).find('option:checked').attr('data-area');
            var agent_name = $(this).find('option:checked').attr('data-agent-name');
            $(this).parent().parent().find('.area').val(area);
            $(this).parent().parent().find('.agent-name').val(agent_name);
        });
