      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cod" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="upop_merId"><?php echo $entry_merId; ?></label>
            <div class="col-sm-10">
              <input type="text" name="upop_merId" value="<?php echo $upop_merId; ?>" placeholder="<?php echo $entry_merId; ?>" id="upop_merId" class="form-control" />
              
              <?php if ($error_upop_merId) { ?>
              	<div class="text-danger"><?php echo $error_upop_merId; ?></div>
              <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="upop_order_status_id" id="input-order-status" class="form-control">
          ...
          <div class="form-group">
            <hr />
            <div class="col-sm-12">
              	技术服务网站: opencartshop.cn <br />
                QQ群 50415210 群共享有免费插件,请加群查看<br />
