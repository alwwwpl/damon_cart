					...
					<div class="tab-content">						
						...
						<div class="panel panel-default">
							<div class="container-fluid">
								...
								<div class="panel-body">
									<table class="table table-striped table-bordered table-hover">
										<?php $dataModule = array("boss_alphabet"=>"Boss - Products by Alphabet","boss_category"=>"Boss - Category","boss_featured"=>"Boss - Featured Product","boss_filterproduct"=>"Boss - Filter product","boss_manufacturer"=>"Boss - Manufacturer","boss_newmegamenu"=>"Boss - Megamenu","boss_quickshop"=>"Boss - QuickShop","boss_revolutionslider"=>"Boss Revolution Slider","boss_tagcloud"=>"Boss - Tag Cloud","latest"=>"Latest","boss_zoom"=>"Boss - Zoom","xoc_twitterupdate"=>"Xoc - Twitter Update","html"=>"HTML Content","bossblog"=>"Boss Blog","blogcategory"=>"Blog Category","blogrecentcomment"=>"Blog Recent Comment","blogrecentpost"=>"Blog Recent Post","blogsearch"=>"Blog Search","blogtagcloud"=>"Blog Tag Cloud","boss_blogfeatured"=>"Blog Featured"); ?>
...
function selectedFontStyle(value,$span){	
	...
	if(value == 'Arial'){
		...
		$('head').append('<link id="link_' + value + '" rel="stylesheet" type="text/css" href="http://fonts.useso.com/css?family=' + font + '">');
