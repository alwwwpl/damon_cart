					...
					<div class="col-sm-12">
						...
						<thead><tr>
							...
							<table class="table table-striped table-bordered table-hover">									
								...
								<tr><td><?php echo $entry_character; ?></td><td class="left">
								<input type="text" name="boss_filterproduct_module[character]" value="<?php echo (isset($module['character']) ? $module['character'] : '') ?>" size="3" class="form-control" /><?php if ($error_character) { ?>
