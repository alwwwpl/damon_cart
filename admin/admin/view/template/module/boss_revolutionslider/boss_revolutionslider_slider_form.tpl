						...
						<div class="bt-caption-setting">
							...
							<div class="bt-noaccordion">
								<table class="table table-striped table-bordered table-hover">
									...
									<tr><td><label class="control-label"><span data-toggle="tooltip" title="" data-original-title="<?php echo $text_class_css_des;?>" ><?php echo $text_class_css;?></span></label></td><td class="left"><select onchange="changeClass(<?php echo $caption_row; ?>,this.value)" name="caption[<?php echo $caption_row; ?>][class_css]" class="form-control">
