...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_gold'] = '金价管理';
        $data['text_customised'] = '定制反馈';
        $data['text_coupons'] = '优惠卷';
        ...
        $data['gold'] = $this->url->link('sale/gold','token=' . $this->session->data['token'], 'SSL');
        $data['customised'] = $this->url->link('sale/customised','token=' . $this->session->data['token'], 'SSL');
        $data['coupons'] = $this->url->link('sale/coupons','token=' . $this->session->data['token'], 'SSL');
