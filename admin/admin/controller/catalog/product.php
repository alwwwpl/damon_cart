...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['vip_price'])) {
            $data['vip_price'] = $this->request->post['vip_price'];
        } elseif (!empty($product_info)) {
            $data['vip_price'] = $product_info['vip_price'];
        } else {
            $data['vip_price'] = '';
        }
        ...
        $data['agents'] = $this->model_catalog_supplier->getAgents();

        if (isset($this->request->post['product_supplier'])) {
            $product_suppliers = $this->request->post['product_supplier'];
        } elseif (isset($this->request->get['product_id'])) {
            $product_suppliers = $this->model_catalog_product->getProductSuppliers($this->request->get['product_id']);
        } else {
        ...
        foreach ($product_suppliers as $product_supplier) {
            $data['product_suppliers'][] = array(
                ...
                'agent_id'            => $product_supplier['agent_id'],
                'agent_name'          => $product_supplier['agent_name'],
                'agent_area'          => $product_supplier['agent_area'],
                'cost_price'          => $product_supplier['cost_price'],
                'price'               => $product_supplier['price'],
                'vip_price'           => $product_supplier['vip_price'],
                'agent_product_name'  => $product_supplier['agent_product_name'],
                'agent_product_stock' => $product_supplier['agent_product_stock'],
                'agent_product_model' => $product_supplier['agent_product_model']
            );
        }
        ...
        $this->load->model('catalog/bidding');

        $data['bidding'] = $this->model_catalog_bidding->getBidding(isset($this->request->get['product_id']) ? $this->request->get['product_id'] : 0);
